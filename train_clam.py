...
def main():
    ...
    parser.add_argument('--dataset', default='xiangya2_te_4_1', type=str, help='Dataset folder name')
    ...
    if args.c_path:
        ...
        save_path = os.path.join('baseline_te_4', datetime.date.today().strftime("%m%d%Y"),

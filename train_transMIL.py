...
def main():
    ...
    parser.add_argument('--dataset', default='xiangya2_ALK_out_1', type=str, help='Dataset folder name')
    ...
    if args.c_path:
        ...
        save_path = os.path.join('baseline_ALK_out', datetime.date.today().strftime("%m%d%Y"),

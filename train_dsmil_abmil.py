...
def main():
    ...
    parser.add_argument('--dataset', default='LUAD_TP53_5_1', type=str, help='Dataset folder name')
    ...
    if args.c_path:
        ...
        save_path = os.path.join('baseline_P53_2', datetime.date.today().strftime("%m%d%Y"),
    ...
    for fold in range(5):
        ...
        for epoch in range(1, args.num_epochs):
            ...
            train_loss_bag = train(train_loader, milnet, criterion, optimizer, args, log_path,
                                   epoch=epoch - 1)  # iterate all bags

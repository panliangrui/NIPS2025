...
def train(train_df, milnet, criterion, optimizer, args, log_path):
    ...
    for i, (bag_label, bag_feats) in enumerate(train_df):
        ...
        optimizer.zero_grad()
        if args.model == 'HIPT':
            bag_prediction, Y_prob, Y_hat = milnet(bag_feats)
...
def main():
    ...
    parser.add_argument('--dataset', default='xiangya2_EGFR_2_1', type=str, help='Dataset folder name')
    # parser.add_argument('--datasets', default='xiangya2', type=str, help='Dataset folder name')
    parser.add_argument('--split', default=0.2, type=float, help='Training/Validation split [0.2]')
    parser.add_argument('--model', default='HIPT', type=str, help='MIL model [HIPT]')
    ...
    if args.model == 'HIPT':
        import Models.HIPT as hipt
        milnet = hipt.HIPT_None_FC(n_classes=args.num_classes).cuda()
    ...
    for fold in range(5):
        ...
        print('lood ahead optimizer in HIPT....')

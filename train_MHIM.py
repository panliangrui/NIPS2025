...
def main():
    ...
    parser.add_argument('--dataset', default='xiangya2_p53_3', type=str, help='Dataset folder name')
    # parser.add_argument('--datasets', default='xiangya2', type=str, help='Dataset folder name')
    parser.add_argument('--split', default=0.2, type=float, help='Training/Validation split [0.2]')
    parser.add_argument('--model', default='mhim', type=str, help='MIL model [mhim]')
    ...
    # Our
    parser.add_argument('--baseline', default='dsmil', type=str, help='Baselin model [attn,selfattn]')
    ...
    # Siamese framework
    parser.add_argument('--cl_alpha', default=0.5, type=float, help='Auxiliary loss alpha')
    ...
    for fold in range(5):
        ...
        train_loader = DataLoader(trainset, 1, shuffle=True, num_workers=2)
        testset = BagDataset(test_path, args)
        test_loader = DataLoader(testset, 1, shuffle=False, num_workers=2)
